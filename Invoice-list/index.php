...
$kode = $_SESSION['kode'];
login($kode,$_SESSION['token'],['master','admin','audit']);
$userName = $_SESSION['user'];
$kode = $_SESSION['kode'];
$akses = $_SESSION['akses'];

$id = removeSpecialChar($_GET['id']);
$inv = data("SELECT * FROM data WHERE no_spk = '$id'");
if(empty($inv)){
...
if(!empty($inv['invoice'])){
	$invoice = json_decode($inv['invoice'],true);

}

$data = data("SELECT * FROM invoice WHERE no_spk in()");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-blue">Invoice - List</h1>
				<a style="height:fit-content; margin-top:25px;" class="btn btn-warning" href="../input-nota/">New Invoice !</a>
			</div>
		</div><!--/.row-->
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						INVOICE FOR : <strong>170-2761-PWGK</strong>
