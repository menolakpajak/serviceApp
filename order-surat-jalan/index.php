...
$data = data("SELECT * FROM surat_jalan ORDER BY date DESC");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-blue">Surat Jalan</h1>
				<a style="height:fit-content; margin-top:25px;" class="btn btn-warning" href="../input-surat-jalan/">New Input !</a>
			</div>
		</div><!--/.row-->
									...
									<li>
										<ul class="dropdown-settings">
											<li><a onclick="cariInvoiceBulan()" href="javascript:void(0)">
												<em id="icon2" class="fa fa-sort-numeric-asc"></em><p id="opsi2" style="display: inline;"> Bulan </p>
											</a></li>
											<li class="divider"></li>
						...
						<div id="container" class="canvas-wrapper">
							...
							<thead>
								...
								<tbody>
									...
									<td><a href="<?= '../detail-invoice/?id='.$datas['id']; ?>"></a></td>
									<td><?= $datas['tujuan'] ; ?></td>
									<td><?= $datas['resi'] ; ?></td>
									</tr>
									<?php $i++ ; ?>
