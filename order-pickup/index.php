...
<head>
	...
	<title>Service - Pickup Order</title>
...
<!-- nav bar -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#">
					<em class="fa fa-handshake-o color-purple"></em>
				</a></li>
				<li class="active">Pickup Order</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-purple">Pickup Order</h1>
						...
						<div id="container" class="canvas-wrapper">
							...
							<thead>
								...
								<tbody>
									...
									<td>
										<a class="color-purple" href="<?= '../detail-pickup/?id='.$datas['no_spk']; ?>">
											<?php
	...
	<script src="../js/custom.js?versi=<?= $versi ; ?>"></script>
	<script src="../event/js/caleandar.js?versi=<?= $versi ; ?>"></script>
	<script src="../event/js/event.js?versi=<?= $versi ; ?>"></script>
