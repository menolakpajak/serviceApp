...
$data = data("SELECT * FROM invoice WHERE save_as = 'invoice' ORDER BY date DESC");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-blue">Order Invoice</h1>
				<a style="height:fit-content; margin-top:25px;" class="btn btn-warning" href="../input-invoice/">New Invoice !</a>
			</div>
		</div><!--/.row-->
