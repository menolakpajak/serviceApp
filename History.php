...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="javascript:void(0)"><em class="fa fa-plus">&nbsp;</em> New Order</a></li>
			<li><a href="charts.html"><em class="fa fa-cogs color-orange">&nbsp;</em> On Proccess</a></li>
			<li><a href="elements.html"><em class="fa fa-check color-green">&nbsp;</em> Done</a></li>
			<li><a href="panels.html"><em class="fa fa-times color-red">&nbsp;</em> Abort</a></li>
			<li><a href="panels.html"><em class="fa fa-handshake-o color-purple">&nbsp;</em> Pick Up</a></li>
