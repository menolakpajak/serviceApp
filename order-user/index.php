									...
									<li>
										<ul class="dropdown-settings">
											<li><a href="javascript:void(0)" onclick="editUser('<?= $datas['id']; ?>','<?= $datas['kodeuser']; ?>','<?= $datas['akses']; ?>','<?= $datas['counter']; ?>','<?= $datas['username']; ?>','<?= $datas['role']; ?>')">
												<em class="fa fa-pencil-square color-orange"></em><p class="color-orange" style="display: inline;"> EDIT </p>
												</a>
											</li>
											<li class="divider"></li>
											<li><a href="javascript:void(0)" onclick="resetUserPwd('<?= $kodeuser; ?>')">
												<em class="fa fa-key color-blue"></em><p class="color-blue" style="display: inline;"> Reset Password </p>
											</a>
											</li>
											<li class="divider"></li>
											<li><a href="javascript:void(0)" onclick="deleteUser('<?= $kodeuser; ?>')">
												<em class="fa fa-trash-o color-red"></em><p class="color-red" style="display: inline;"> DELETE </p>
												</a>
											</li>
										</ul>
									</li>
