...
$data = data("SELECT * FROM data WHERE status = 'done' ORDER BY date_finish");
...
<head>
	...
	<title>Service - Order Done</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<form action="javascript:void(0)">
			<div class="form-group">
				<input id="keyword-done" type="text" class="form-control" placeholder="Search">
			</div>
		</form>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Order Done</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-green">Order Done</h1>
								...
								<tbody>
									...
									<?php foreach ($data as $datas): ?>
										...
										<tr>
											...
											<td>
												<a class="color-blue" href="<?= '../detail-done/?id=' . $datas['no_spk']; ?>">
													<?php
