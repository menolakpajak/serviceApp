...
foreach ($_SESSION['user_list'] as $item) {
	if ($item[0] === $user) {
		$found = true;
		break;
	}
...
$data = data("SELECT * FROM earnings WHERE (penerima = '$user' AND date like '$now%' AND status IS NULL) ORDER BY date");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Sharing Unpaid</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-orange">Sharing Unpaid</h1>
			</div>
		</div><!--/.row-->
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li>
										<ul class="dropdown-settings">
											<li><a onclick="cariSharingBulan('sharingUnpaid','<?= $user; ?>')" href="javascript:void(0)">
													<em id="icon2" class="fa fa-calendar"></em>
													<p id="opsi2" style="display: inline;"> Bulan </p>
												</a>
											</li>
											<li class="divider"></li>
											<li><a href="javascript:void(0)" class="color-orange">
													<em id="icon2" class="fa fa-upload"></em>
													<p style="display: inline;" class="color-orange"> UPDATE</p>
												</a>
											</li>
											<li class="divider"></li>
											<li><a href="../sharing/?<?= $user; ?>&paid" class="color-purple">
													<em id="icon2" class="fa fa-usd"></em>
													<p style="display: inline;" class="color-purple"> PAID PAGE</p>
												</a>
											</li>
											<li class="divider"></li>
											<li>
