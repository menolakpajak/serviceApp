...
<!-- nav bar -->
		...
		<div class="row">	
			<div class="col-lg-12" >
				<div style="display: flex; flex-direction:row;">
					<h1 style="font-weight: 500;" class="page-header color-green"><?= ucfirst($data['status']) ; ?> </h1>
					<i style="font-size: x-large; margin-top:8px;" class="fa fa-check color-green" aria-hidden="true"></i>
				</div>
	...
	<div id="ajax-update">
					...
					<div id="proses_info" style="border:1px solid #ffa500b3 !important;" class="<?= $acc ; ?>">
						<div style="background-color: #62ff00b3; " class="title_fill">
							<h3>Proses Info</h3>
						</div>
					...
					<div id="action" >
						<div class="title_fill">
							...
							<?php if($akses == 'master') :?>
								<div class="action-grup">
									<a style="margin-bottom: 5px;" href="javascript:void(0)" class="btn btn-primary" onclick="editDone()"> Edit </a>
							...
							<?php endif; ?>
								<div class="action-grup">
									...
									<a style="text-align: center;height:fit-content" href="../print/?id=<?= $id ; ?>" class="btn btn-dark">Receipt</a>
								</div>
