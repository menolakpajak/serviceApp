...
if($data['status'] == 'proses'){
	header('Location: ../detail-proses/?id='.$id); die;}
if($data['status'] == 'done'){
		...
		<div class="row">	
			<div class="col-lg-12" >
				<div style="display: flex; flex-direction:row;">
					<h1 style="font-weight: 500;" class="page-header color-red"><?= ucfirst($data['status']) ; ?> </h1>
					<i style="font-size: x-large; margin-top:8px;" class="fa fa-times color-red" aria-hidden="true"></i>
				</div>
				...
				<?php if($data['acc'] == 'on'){$acc = 'acc';}else{$acc = '';} ?>
					...
					<div id="action" >
						<div class="title_fill">
							...
							<?php if($akses == 'master') :?>
								<div class="action-grup">
									<a style="margin-bottom: 5px;" href="javascript:void(0)" class="btn btn-primary" onclick="editAbort()"> Edit </a>
									<a href="javascript:void(0)" class="btn btn-danger" onclick="deleteData('abort','<?= $id ; ?>')"> Delete </a>
								</div>
							<?php endif; ?>
								<div class="action-grup">
									<a style="margin-bottom: 5px;" href="javascript:void(0)" class="btn btn-purple" onclick="pickup('<?= $id ; ?>','<?= $status ; ?>')"> Next to Pickup </a>
