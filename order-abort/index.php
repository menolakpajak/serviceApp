...
$data = data("SELECT * FROM data WHERE status = 'abort' ORDER BY date_finish");
...
<head>
	...
	<title>Service - Order Abort</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<form action="javascript:void(0)">
			<div class="form-group">
				<input id="keyword-abort" type="text" class="form-control" placeholder="Search">
			</div>
		</form>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#">
						<em class="fa fa-times color-red"></em>
					</a></li>
				<li class="active">Order Abort</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12" style="display:flex; justify-content:space-between">
				<h1 class="page-header color-red">Order Abort</h1>
								...
								<tbody>
									...
									<?php foreach ($data as $datas): ?>
										...
										<tr>
											...
											<td>
												<a class="color-red" href="<?= '../detail-abort/?id=' . $datas['no_spk']; ?>">
													<?php
			...
			<div class="col-md-6">
				<div class="panel panel-default articles">
					...
					<div class="panel-body articles-container">
						...
						<?php foreach ($data as $datas): ?>
							<?php $datTime = explode('-', date('d-M', strtotime($datas['date_finish']))); ?>
