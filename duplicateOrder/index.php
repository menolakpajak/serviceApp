...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">DUPLICATE INPUT</h1>
			</div>
		</div><!--/.row-->
									...
									<div id="personal_info">
										...
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="text" class="form-control" id="nama" name="nama" maxlength="100" autocomplete="off" value="<?= $data['nama']; ?>" required>
											</div>
										</div>
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="number" class="form-control" id="wa" name="wa" maxlength="50" autocomplete="off" value="<?= $data['wa']; ?>" required>
											</div>
										</div>
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="number" class="form-control" id="no_tlp" name="no_tlp" maxlength="50" autocomplete="off" value="<?= $data['no_tlp']; ?>" placeholder="Optional">
											</div>
										</div>
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="text" class="form-control" id="alamat" name="alamat" autocomplete="off" value="<?= $data['alamat']; ?>" required>
											</div>
										</div>
									</div>
									...
									<div id="unit_info">
										...
										<div class="form-group input">
											...
											<div class="box">
												...
												<select id="tipe_unit" class="custom-select" name="tipe_unit" autocomplete="off" required>
													<option selected value="<?= $data['tipe']; ?>"><?= ucfirst($data['tipe']); ?></option>
										...
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="text" class="form-control" id="unit" name="unit" maxlength="200" autocomplete="off" value="<?= $data['unit']; ?>" required>
											</div>
										</div>
										<div class="form-group input">
											...
											<div class="box">
												...
												<input type="text" class="form-control" id="serial_number" name="serial_number" maxlength="255" autocomplete="off" value="<?= $data['sn']; ?>" required>
											</div>
										</div>
									</div>
								</div>
