		...
		<div class="row">
			<div class="col-lg-12">
				<div style="display: flex; flex-direction:row;">
					<h1 style="font-weight: 500;" class="page-header color-red">Deleted</h1>
					<i style="font-size: x-large; margin-top:8px;" class="fa fa-trash color-red" aria-hidden="true"></i>
				</div>
							...
							<form action="tes.php" method="post">
								...
								<div id="ajax-update">
									...
									<div id="proses_info" style="border:1px solid #ffa500b3 !important;" class="<?= $acc; ?>">
										...
										<div id="head5" class="form-group">
											...
											<div class="form-group input color-red">
												<label for="date_update">Deleted At :</label>
												<div class="box">
													<i style="font-size: x-large;" class="fa fa-calendar" aria-hidden="true"></i>
									...
									<div id="action">
										...
										<div class="action">
											<?php if ($akses == 'master'): ?>
												<a href="javascript:void(0)" class="btn btn-danger mt-1" onclick="hardDelete('deleted','<?= $id; ?>')"> Hard Delete </a>
											<?php endif; ?>
											<a href="../duplicateOrder/?id=<?= $id; ?>" class="btn btn-info mt-1">Duplicate</a>
											<a href="../print/deleted.php?id=<?= $id; ?>" class="btn btn-dark mt-1" target="_blank">Receipt</a>
										</div>
