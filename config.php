...
$url = "https://sinar-service.com/detail-new?id=";
...
if(!empty($new)){
    ...
    foreach($new as $new_wait){
        ...
        $wa_text = waTextNew($new_wait['nama'],
                            $new_wait['no_spk'],
                            $new_wait['tipe'],
                            $new_wait['unit'],
                            $new_wait['sn'],
...
if(!empty($proses)){
    ...
    foreach($proses as $new_wait){
        $wa_text = waTextProses($new_wait['nama'],
                                $new_wait['wa'],
                                $new_wait['no_spk'],
                                $new_wait['tipe'],
                                $new_wait['unit'],
        ...
        if(!empty($new_wait['date_update'])){
            ...
            $wa_text = waTextUpdate($new_wait['nama'],
                                $new_wait['wa'],
                                $new_wait['no_spk'],
                                $new_wait['tipe'],
                                $new_wait['unit'],
...
if(!empty($finish)){
    ...
    foreach($finish as $new_wait){
        $new_date_info = $new_wait['date_finish'];
            ...
            $wa_text = waTextDone($new_wait['nama'],
                                $new_wait['wa'],
                                $new_wait['no_spk'],
                                $new_wait['tipe'],
                                $new_wait['unit'],
